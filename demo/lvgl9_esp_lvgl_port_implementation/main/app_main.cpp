...
extern "C" void app_main(void) {
    ...
    // lv_display_set_resolution(disp, LCD_WIDTH, LCD_HEIGHT);          // Seteaza rezolutia
    // software lv_display_set_physical_resolution(disp, LCD_WIDTH, LCD_HEIGHT); // Actualizeaza
    // rezolutia reala lv_display_set_rotation(disp, (lv_display_rotation_t)0);         // Seteaza
    // rotatia lvgl lv_display_set_render_mode(
